...
const translations: Record<string, Record<Language, string>> = {
  ...
  recordAudio: {
    ...
    [Language.ARABIC]: 'تسجيل الصوت',
    [Language.FRENCH]: 'Enregistrer Audio',
  ...
  upload: {
    ...
    [Language.FRENCH]: 'Téléverser Fichier',
  ...
  fileTooLarge: {
      ...
      [Language.ARABIC]: "الملف كبير جدًا ({fileSize} ميجابايت). الرجاء استخدام ملف أصغر من {maxSize} ميجابايت، أو استخدام جوجل درايف للملفات الأكبر.",
      ...
      [Language.SPANISH]: "El archivo es demasiado grande ({fileSize} MB). Por favor, use un archivo de menos de {maxSize} MB, o use Google Drive para archivos más grandes.",
  },
  selectedFile: {
  ...
  connectDrive: {
    ...
    [Language.FRENCH]: 'Connecter & Sélectionner',
    [Language.SPANISH]: 'Conectar y Seleccionar',
  },
  selectFile: {
    [Language.ENGLISH]: 'Select File from Drive',
    [Language.HEBREW]: 'בחר קובץ מדרייב',
    [Language.ARABIC]: 'اختر ملفًا من درايف',
    [Language.FRENCH]: 'Sélectionner depuis Drive',
    [Language.SPANISH]: 'Seleccionar de Drive',
  },
  startRecording: {
  ...
  recordedAudio: {
   ...
   clearRecording: {
      ...
      [Language.SPANISH]: "Limpiar Grabación",
    },
   iframeMessage: {
